package net.unicraft.gismi.levelmod;
...
public class Levelmod {
    ...
    public static final String MODID = "levelmod";
    ...
    public Levelmod() {
        ...
        ModLoadingContext.get().registerConfig(ModConfig.Type.COMMON, LevelmodCommonConfig.SPEC,"levelmod-common.toml");
